...
Invocation (per project convention):
    PYTHONPATH=. .venv/bin/python benchmarks/benchmark_step9.py
"""
...
def run_timer(name, setup_str, stmt_str, iterations=5000, repeats=5):
    ...
    for _ in range(repeats):
        # Warmup
        for _ in range(100):
            exec(stmt_str, globals())  # noqa: S102 — controlled benchmark statement execution
        # Actual measurement
